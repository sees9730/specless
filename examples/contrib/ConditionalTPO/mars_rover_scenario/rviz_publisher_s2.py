...
# Palette
# ---------------------------------------------------------------------------
MARS_GROUND   = ColorRGBA(r=247/255, g=186/255, b=87/255, a=1.0)
MARS_DARK     = ColorRGBA(r=247/255, g=186/255, b=87/255, a=1.0)
...
def _terrain_color(h):
    """Mars surface colour: dark rust in valleys, lighter ochre on ridges."""
    # r = 0.45 + 0.28 * h
    # g = 0.20 + 0.16 * h
    # b = 0.08 + 0.08 * h
    r = 0.85 + 0.1 * h
    g = 0.5 + 0.1 * h
    b = 0.1 + 0.1 * h
    # return ColorRGBA(r=247/255, g=186/255, b=87/255, a=1.0)
