"""
Conditional TPO — AND condition example (e2 optional)
======================================================
...
Optional:   e2, e4
e4 visited only if BOTH e2 AND e3 visited.
Since e2 is optional and costly, solver skips e2 → ze4=0 → e4 skipped.
