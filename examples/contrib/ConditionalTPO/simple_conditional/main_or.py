"""
Conditional TPO — OR condition example
========================================

5 nodes: depot(0), e1(1), e2(2), e3(3), e4(4)

Mandatory:  depot, e1, e2, e3
Optional:   e4 — visit if e2 OR e3 visited

OR linearization (paper Def 5):
  ze4 >= z2
  ze4 >= z3
  ze4 <= z2 + z3

Since e2 and e3 are both mandatory, ze4 is always 1 here.
e4 is always visited.
